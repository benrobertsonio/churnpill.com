---
title: "What is churn rate in SaaS and why every founder gets it wrong"
...
That's why [Chargebee's research](https://www.chargebee.com/blog/churn-rate-calculation-saas/) shows successful SaaS companies track revenue churn as their primary retention metric.
...
**B2B SaaS companies** lock customers into longer relationships. Higher switching costs, integration complexity, and annual contracts create natural retention barriers. [Chargebee's data](https://www.chargebee.com/blog/churn-rate-calculation-saas/) shows top B2B SaaS companies maintain annual churn rates around 5% or less.
...
[Chargebee's data](https://www.chargebee.com/blog/churn-rate-calculation-saas/) shows involuntary churn averages 2-4% monthly across SaaS companies. That's often 30-40% of total churn - and it's completely preventable with proper payment retries.
...
1. **Previous week's customer losses** (raw count and percentage)
2. **Previous week's revenue churn** (absolute dollars and percentage)
3. **Voluntary vs involuntary churn ratio** (should be 70/30 or better)
4. **New customer contamination check** (are you including new customers in calculations?)
5. **High-value customer losses** (any customer representing >1% of monthly revenue)
